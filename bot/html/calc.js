...
const CalcModule = {
        ...
        inputs.forEach((el, idx) => {
            ...
            el.addEventListener('focus', () => {
                if(wrapper) {
                    ...
                    wrapper.style.boxShadow = '0 0 0 4px rgba(10, 132, 255, 0.25), inset 0 2px 10px rgba(255,255,255,0.05), 0 10px 30px rgba(0,0,0,0.5)';
                }
            });
    ...
    updateDisplay(points, rank) {
        ...
        if (start !== points) {
            ...
            this.dom.finaValue.style.filter = 'drop-shadow(0 20px 50px rgba(10, 132, 255, 0.6))';
            setTimeout(() => {
                this.dom.finaValue.style.transform = 'scale(1)';
                this.dom.finaValue.style.filter = 'drop-shadow(0 15px 40px rgba(10, 132, 255, 0.3))';
            }, 150);
        }
        ...
        RANKS.forEach((r) => {
            ...
            row.innerHTML = `
                <div style="width:100%">
                    ...
                    ${isNext ? `<div class="norm-progress"><div class="progress-fill" style="width: ${progress}%; box-shadow: 0 0 10px rgba(10,132,255,0.8);"></div></div>` : ''}
                </div>`;
